...
export const MODEL_DEFS = {
  ...
  minimax_m27: { name:"MiniMax M2.7 (Ollama)", short:"M2.7",   provider:"MiniMax via Ollama", color:"#06B6D4", bg:"#040E12", border:"#083040", icon:"⬡", apiType:"compat", maxTokens:32768, inputLimit:28000, free:false, keyName:"ollama_cloud", keyLink:"https://ollama.com/settings/tokens", desc:"Clé Ollama gratuite · #1 open-source code & agents", baseUrl:"https://ollama.com/v1", model:"minimax-m2.7:cloud" },
  minimax_m25: { name:"MiniMax M2.5 (Ollama)", short:"M2.5",   provider:"MiniMax via Ollama", color:"#0891B2", bg:"#040C10", border:"#062030", icon:"⬡", apiType:"compat", maxTokens:32768, inputLimit:28000, free:false, keyName:"ollama_cloud", keyLink:"https://ollama.com/settings/tokens", desc:"Clé Ollama gratuite · SWE-Bench = Claude Opus 4.6", baseUrl:"https://ollama.com/v1", model:"minimax-m2.5:cloud" },
  // ── OpenRouter (clé gratuite) ─────────────────────────────────────
  nemotron3:   { name:"Nemotron 3 Super",      short:"Nemotron", provider:"NVIDIA via OpenRouter", color:"#76B900", bg:"#081200", border:"#1A3300", icon:"⬟", apiType:"compat", maxTokens:131072, inputLimit:32000, free:false, keyName:"openrouter", keyLink:"https://openrouter.ai/keys", desc:"Clé OpenRouter · 120B MoE, #1 pour agents multi-étapes", baseUrl:"https://openrouter.ai/api/v1", model:"nvidia/nemotron-3-super-49b-v1" },
