...
export const BASE_WEB_AIS = [
  ...
  // ── Local / Self-hosted ────────────────────────────────────────
  { id:"openwebui",    name:"Open WebUI",      subtitle:"Open WebUI • 100% Gratuit & Open-source", cat:"local", url:"https://openwebui.com/",              color:"#0EA5E9", icon:"🖥", trend:9,  desc:"Interface ChatGPT-like pour Ollama et autres backends locaux. RAG sur documents, personas, historique, multimodal (LLaVA), API OpenAI-compatible sur localhost:3000.", tags:["Ollama","Local","RAG","Open-source","API compatible"] },
  { id:"ollama_web",   name:"Ollama",          subtitle:"Ollama • 100% Gratuit & Open-source",     cat:"local", url:"https://ollama.com/",                 color:"#34D399", icon:"🦙", trend:8,  desc:"Lance Llama 3, Mistral, Gemma, Phi-3 et 100+ modèles localement sur ta GPU ou CPU. Inference rapide, zéro cloud, 100% privé.", tags:["Local","GPU","Llama","Mistral","Privé"] },
