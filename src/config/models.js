...
export const BASE_WEB_AIS = [
  ...
  { id:"chatgpt",      name:"ChatGPT",         subtitle:"OpenAI • Gratuit",      cat:"gratuit",    url:"https://chatgpt.com/",                    color:"#74C98C", icon:"◈", trend:10, desc:"Le chatbot IA le plus utilisé au monde. GPT-4o gratuit, DALL-E, navigation web, plugins, mémoire persistante.", tags:["Généraliste","Web","Images","Plugins","Mémoire"] },
  { id:"claude_web",   name:"Claude.ai",       subtitle:"Anthropic • Gratuit",   cat:"gratuit",    url:"https://claude.ai/",                      color:"#D4A853", icon:"✦", trend:10, desc:"Meilleur pour l'analyse de longs documents, le code et la rédaction. Contexte 200k tokens, upload de fichiers, projets.", tags:["Documents","Code","Rédaction","Analyse","Projets"] },
  { id:"gemini_web",   name:"Gemini",          subtitle:"Google • Gratuit",      cat:"gratuit",    url:"https://gemini.google.com/",              color:"#6BA5E0", icon:"◇", trend:9,  desc:"IA Google multimodale. Analyse images/vidéos, intégré à Google Drive/Gmail, modèle 2.5 Flash ultra-rapide.", tags:["Multimodal","Google Drive","Images","Vidéo","Gratuit"] },
  { id:"deepseek_web", name:"DeepSeek",        subtitle:"DeepSeek • Gratuit",    cat:"gratuit",    url:"https://chat.deepseek.com/",              color:"#A0C8FF", icon:"⬡", trend:9,  desc:"Modèle chinois open-source, exceptionnel en raisonnement mathématique et code. R1 pense étape par étape visible.", tags:["Raisonnement","Maths","Code","Open-source","Gratuit"] },
  ...
  { id:"copilot",      name:"Copilot",         subtitle:"Microsoft • 100% Gratuit", cat:"gratuit", url:"https://copilot.microsoft.com/",          color:"#4FC3F7", icon:"⊞", trend:8,  desc:"GPT-4o via Microsoft entièrement gratuit, sans limite. Intégré à Windows 11, Edge, Office. Génération images DALL-E.", tags:["GPT-4o gratuit","Windows","Office","Images","Bing"] },
  { id:"mistral_web",  name:"Le Chat",         subtitle:"Mistral AI • Gratuit",  cat:"gratuit",    url:"https://chat.mistral.ai/",                color:"#FF8C69", icon:"▲", trend:7,  desc:"Interface officielle Mistral. Mistral Large 2 gratuit, excellent en français. Mode Flash ultra-rapide, Canvas pour écrire.", tags:["Français","Rapide","Canvas","Europe","Mistral Large"] },
  { id:"kimi_web",     name:"Kimi",            subtitle:"Moonshot AI • Gratuit", cat:"gratuit",    url:"https://www.kimi.com/",                   color:"#E07FA0", icon:"月", trend:7,  desc:"Fenêtre de contexte massive de 1M tokens — analyse de très longs documents PDF, livres entiers, bases de code.", tags:["1M tokens","Longs docs","PDF","Analyse","Contexte"] },
  { id:"qwen_web",     name:"Qwen Chat",       subtitle:"Alibaba • Gratuit",     cat:"gratuit",    url:"https://chat.qwen.ai/",                   color:"#E0A850", icon:"千", trend:7,  desc:"Qwen3-235B gratuit. Excellent en code, maths et multilingue. Mode thinking activable, concurrence GPT-4o sur les benchmarks.", tags:["Code","Maths","Multilingue","Thinking","Alibaba"] },
  { id:"zai",          name:"Z.ai",            subtitle:"z.ai • Gratuit",        cat:"gratuit",    url:"https://chat.z.ai/",                      color:"#B07FE0", icon:"Ζ", trend:8,  desc:"Accès gratuit à GPT-4o, Claude 3.5, Gemini Pro et Z1 dans une seule interface. Comparaison side-by-side des modèles.", tags:["Multi-modèles","GPT-4o","Claude","Gemini","Comparaison"] },
  { id:"llama_meta",   name:"Meta AI",         subtitle:"Meta • Gratuit",        cat:"gratuit",    url:"https://www.meta.ai/",                    color:"#1877F2", icon:"⬟", trend:7,  desc:"Llama 4 Maverick directement via Meta. Intégré à WhatsApp, Instagram, Messenger. Génération images, recherche web.", tags:["Llama 4","WhatsApp","Instagram","Images","Gratuit"] },
  { id:"t3chat",       name:"T3 Chat",         subtitle:"T3 • Gratuit",          cat:"gratuit",    url:"https://t3.chat/",                        color:"#A855F7", icon:"T", trend:6,   desc:"Interface minimaliste ultra-rapide, zéro friction. Accès Llama 4, Gemini Flash, DeepSeek R1 gratuit, historique local.", tags:["Rapide","Minimaliste","Gratuit","Multi-modèles","Privé"] },
  { id:"cerebras_w",   name:"Cerebras Chat",   subtitle:"Cerebras • Gratuit",    cat:"gratuit",    url:"https://inference.cerebras.ai/",          color:"#FF6B35", icon:"◉", trend:6,  desc:"Inférence sur puce dédiée — 2000+ tokens/seconde. Le chatbot le plus RAPIDE au monde, idéal pour prototypage rapide.", tags:["Ultra-rapide","2000 tok/s","Llama","Prototype","Vitesse"] },
  { id:"sambanova_w",  name:"SambaNova Chat",  subtitle:"SambaNova • Gratuit",   cat:"gratuit",    url:"https://cloud.sambanova.ai/",             color:"#34D399", icon:"∞", trend:6,  desc:"Accès gratuit à Llama 4 Maverick et DeepSeek-R1 avec vitesse d'inférence très élevée. Bonne alternative à Groq.", tags:["Llama 4","DeepSeek-R1","Rapide","Gratuit","API"] },
  // ── Recherche ───────────────────────────────────────────────────
  { id:"perplexity",   name:"Perplexity",      subtitle:"Perplexity AI • Gratuit", cat:"recherche", url:"https://www.perplexity.ai/",            color:"#20B2AA", icon:"◎", trend:9,  desc:"Moteur de recherche IA avec sources citées en temps réel. Remplace Google pour les questions complexes. Threads, Spaces.", tags:["Recherche web","Sources","Temps réel","Threads","Citer"] },
  { id:"phind",        name:"Phind",           subtitle:"Phind • Gratuit",       cat:"recherche",   url:"https://www.phind.com/",                color:"#8B5CF6", icon:"φ", trend:7,   desc:"Moteur de recherche IA spécialisé pour les développeurs. Répond aux questions de code avec le contexte des docs officielles.", tags:["Code","Dev","Documentation","Stack Overflow","Technique"] },
  { id:"you",          name:"You.com",         subtitle:"You.com • Gratuit",     cat:"recherche",   url:"https://you.com/",                      color:"#6366F1", icon:"Y", trend:6,   desc:"Moteur IA hybride : recherche web classique + réponses IA. Modes spécialisés : Research, Code, Writing, Smart.", tags:["Web","Recherche","Modes","Code","Privé"] },
  { id:"andi",         name:"Andi Search",     subtitle:"Andi • Gratuit",        cat:"recherche",   url:"https://andisearch.com/",               color:"#10B981", icon:"∂", trend:5,   desc:"Moteur de recherche conversationnel sans publicité, sans tracking. Résume les pages web, répond directement.", tags:["Sans pub","Privé","Résumé","Conversationnel","Clean"] },
  // ── Multi-modèles / Playground ──────────────────────────────────
  { id:"hf",           name:"HuggingFace Chat",subtitle:"HuggingFace • Gratuit", cat:"multimodele", url:"https://huggingface.co/chat/",          color:"#FFD21E", icon:"🤗", trend:8,  desc:"Accès à 100+ modèles open-source : Llama 4, Mistral, Gemma, Phi, Falcon... Assistants personnalisables, RAG, web search.", tags:["Open-source","100+ modèles","Llama","Mistral","Assistants"] },
  { id:"openrouter_w", name:"OpenRouter Chat",  subtitle:"OpenRouter • Gratuit",  cat:"multimodele", url:"https://openrouter.ai/chat",            color:"#E07FA0", icon:"⊕", trend:8,  desc:"200+ modèles en un seul endroit. Modèles gratuits : Llama, Gemma, DeepSeek. Comparaison de prix entre providers API.", tags:["200+ modèles","Gratuits","API","Prix","Comparaison"] },
  { id:"poe",          name:"Poe",             subtitle:"Quora • Gratuit",       cat:"multimodele", url:"https://poe.com/",                      color:"#9CA3AF", icon:"P", trend:7,   desc:"Plateforme Quora réunissant Claude, GPT-4, Llama, Stable Diffusion. Création de chatbots personnalisés, partage de bots.", tags:["Claude","GPT-4","Llama","Bots custom","Quora"] },
  { id:"lmsys",        name:"LMArena",         subtitle:"LMSys • Gratuit",       cat:"multimodele", url:"https://lmarena.ai/",                   color:"#F59E0B", icon:"⚔", trend:7,   desc:"Arène de comparaison de modèles IA en mode aveugle. Vote pour le meilleur. Leaderboard Chatbot Arena de référence mondiale.", tags:["Arène","Benchmark","Comparaison","Leaderboard","Aveugle"] },
  { id:"groq_web",     name:"Groq Playground", subtitle:"Groq • Gratuit",        cat:"multimodele", url:"https://console.groq.com/playground",   color:"#F97316", icon:"⚡", trend:6,  desc:"Interface Groq pour tester Llama 4, Qwen3, DeepSeek à des vitesses extrêmes. Utile pour prototyper des prompts API.", tags:["Rapide","Llama","Qwen3","Prototype","API"] },
  { id:"together_w",   name:"Together AI",     subtitle:"Together • Gratuit",    cat:"multimodele", url:"https://api.together.ai/playground",    color:"#F59E0B", icon:"∿", trend:6,   desc:"Playground cloud pour Llama, Mixtral, SDXL. Infrastructure open-source dédiée, fine-tuning disponible, API performante.", tags:["Open-source","Fine-tuning","Llama","SDXL","API"] },
  { id:"nat_dev",      name:"Nat.dev",         subtitle:"Nat.dev • Gratuit",     cat:"multimodele", url:"https://nat.dev/",                      color:"#A78BFA", icon:"⋄", trend:5,   desc:"Playground comparatif multi-modèles côte à côte. Teste GPT-4, Claude, Llama avec le même prompt simultanément.", tags:["Côte à côte","Comparaison","GPT-4","Claude","Prompt"] },
  // ── Image IA ────────────────────────────────────────────────────
  { id:"ideogram",     name:"Ideogram",        subtitle:"Ideogram • Gratuit",    cat:"image",       url:"https://ideogram.ai/",                  color:"#EC4899", icon:"🎨", trend:9,  desc:"Génération d'images IA avec texte intégré parfaitement. Idéal logos, affiches, thumbnails. Style photoréaliste, illustration.", tags:["Texte dans images","Logos","Affiches","Photoréaliste","Tendance"] },
  { id:"adobe_ff",     name:"Adobe Firefly",   subtitle:"Adobe • Gratuit",       cat:"image",       url:"https://firefly.adobe.com/",            color:"#FF6B35", icon:"🔥", trend:8,  desc:"Génération d'images 100% légale, entraîné sur images sous licence Adobe. Intégré à Photoshop, Illustrator. Sans problèmes de droits.", tags:["Légal","Adobe","Photoshop","Commercial","Droits"] },
  { id:"kling",        name:"Kling AI",        subtitle:"Kuaishou • Gratuit",    cat:"image",       url:"https://klingai.com/",                  color:"#0EA5E9", icon:"▶", trend:8,   desc:"Génération vidéo IA 5s-10s haute qualité et images. Concurrent direct de Sora, accès gratuit limité. Très réaliste.", tags:["Vidéo IA","Images","Réaliste","Gratuit","Concurrent Sora"] },
  { id:"leonardo",     name:"Leonardo.ai",     subtitle:"Leonardo • Gratuit",    cat:"image",       url:"https://app.leonardo.ai/",              color:"#7C3AED", icon:"🖼", trend:7,   desc:"150 crédits/jour gratuits. Spécialisé jeux vidéo, concept art, personnages. Modèles fine-tunés, ControlNet, inpainting.", tags:["Jeux vidéo","Concept art","Personnages","ControlNet","Inpainting"] },
  { id:"playground_ai",name:"Playground AI",  subtitle:"Playground • Gratuit",  cat:"image",       url:"https://playground.com/",               color:"#F472B6", icon:"🎭", trend:6,   desc:"500 images/jour gratuites avec Playground v3. Interface simple, édition d'images, mix de styles, fond transparent.", tags:["500/jour","Édition","Mix styles","Transparent","Simple"] },
  // ── Code & Développement ────────────────────────────────────────
  { id:"bolt",         name:"Bolt.new",        subtitle:"StackBlitz • Gratuit",  cat:"code",        url:"https://bolt.new/",                     color:"#7C3AED", icon:"⚡", trend:10,  desc:"Génère des applications web complètes (React, Vue, Node) en quelques secondes depuis une description. Preview live intégré.", tags:["Full-stack","React","Preview live","Génération app","Tendance"] },
  { id:"lovable",      name:"Lovable",         subtitle:"Lovable • Gratuit",     cat:"code",        url:"https://lovable.dev/",                  color:"#FF6B6B", icon:"♥", trend:10,  desc:"Génère des applications fullstack avec backend Supabase depuis une description. Déploiement 1-clic, édition visuelle.", tags:["Fullstack","Supabase","Backend","Déploiement","No-code"] },
  { id:"cursor",       name:"Cursor",          subtitle:"Cursor AI • Gratuit/Pro", cat:"code",      url:"https://cursor.com/",                   color:"#7B8CDE", icon:"⌨", trend:10,  desc:"IDE basé VS Code avec IA intégrée. Complète le code, comprend tout le codebase, chat inline, refactoring automatique.", tags:["IDE","VS Code","Codebase","Chat inline","Refactoring"] },
  { id:"v0_dev",       name:"v0 by Vercel",    subtitle:"Vercel • Gratuit",      cat:"code",        url:"https://v0.dev/",                       color:"#6366F1", icon:"▲", trend:9,   desc:"Génère des composants React/Next.js avec Tailwind et Shadcn UI depuis une description ou screenshot. Intégration Vercel.", tags:["React","Next.js","Shadcn","Tailwind","UI components"] },
  { id:"github_cop",   name:"GitHub Copilot",  subtitle:"GitHub • $10/mois",     cat:"code",        url:"https://github.com/features/copilot",   color:"#6E40C9", icon:"⌥", trend:9,   desc:"IA de code leader dans VS Code, JetBrains, Vim. Complète, suggère, explique, génère des tests. Claude + GPT-4 sous le capot.", tags:["VS Code","JetBrains","Tests","Complétion","Claude+GPT"] },
  { id:"replit",       name:"Replit AI",       subtitle:"Replit • Gratuit",      cat:"code",        url:"https://replit.com/",                   color:"#F26207", icon:"∈", trend:7,   desc:"IDE cloud avec IA intégrée, hébergement instantané. Idéal apprentissage, prototypage, partage de code. 50+ langages.", tags:["Cloud IDE","Hébergement","Apprentissage","50+ langages","Partage"] },
  // ── Audio / Voix ────────────────────────────────────────────────
  { id:"elevenlabs",   name:"ElevenLabs",      subtitle:"ElevenLabs • Gratuit",  cat:"audio",       url:"https://elevenlabs.io/",                color:"#6366F1", icon:"🔊", trend:9,   desc:"Synthèse et clonage vocal ultra-réaliste en 29 langues. Clone ta voix en 1 minute. API, doublage vidéo automatique.", tags:["Clonage vocal","29 langues","Doublage","TTS","API"] },
  { id:"suno",         name:"Suno AI",         subtitle:"Suno • Gratuit",        cat:"audio",       url:"https://suno.com/",                     color:"#10B981", icon:"🎵", trend:9,   desc:"Génère des chansons complètes avec paroles et voix depuis un texte. Tous les styles musicaux. 50 crédits/jour gratuits.", tags:["Musique","Paroles","Voix","Tous styles","50 crédits/jour"] },
  { id:"udio",         name:"Udio",            subtitle:"Udio • Gratuit",        cat:"audio",       url:"https://www.udio.com/",                 color:"#8B5CF6", icon:"🎶", trend:8,   desc:"Génération musicale IA haute fidélité. Contrôle fin du style, BPM, instruments. Concurrent de Suno avec meilleure qualité audio.", tags:["Haute qualité","Style","BPM","Instruments","Concurrent Suno"] },
  // ── Premium / Payant ────────────────────────────────────────────
